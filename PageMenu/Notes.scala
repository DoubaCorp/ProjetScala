...
//break
      ...
      case ex: ClassNotFoundException =>
        java.util.logging.Logger
          .getLogger(classOf[Notes].getName)
...
class Notes extends javax.swing.JFrame {
...
//public class FenetreListeProduit extends javax.swing.JFrame {
  ...
  val requeteListe: String = "select * from resultat"
  ...
  try {
    ...
    while (resultat.next()) model.addRow(
      Array(resultat.getString("idEtudiant"),
            resultat.getString("codeMatiere"),
            resultat.getString("Note1"),
            resultat.getString("Note2"),
            resultat.getString("Exam")))
  } catch {
